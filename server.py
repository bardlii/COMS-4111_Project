...
def feed():
    ...
    return render_template('feed.html', post.author=post_out['Post_owner_id'], post.date=post_out['Post_creation_date'], post.image=post_out['Post_image_url'], post.text=post_out['Post_text'])
